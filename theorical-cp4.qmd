...
#sol[
Four common errors include: (1) insufficient boundary conditions that leave the structure with unrestrained rigid body modes; (2) internal mechanisms, such as collinear truss elements without transverse support or unresisted hinges; (3) disconnected elements or unmerged nodes that create floating, independent parts; and (4) missing material or geometric properties (e.g., zero Young's modulus or zero area) yielding zero-stiffness entries.
]
